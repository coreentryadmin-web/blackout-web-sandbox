...
const TERMS: Record<string, { term: string; def: string }[]> = {
  "dealer-greeks": [
    { term: "CHARM", def: "The second-order Greek measuring the rate of change of delta with respect to time (dDelta/dTime). As options approach expiry, CHARM-driven delta decay forces dealers to unwind their delta hedges. On expiry day, CHARM flows can exert measurable directional pressure in the final 60â€“90 minutes of the session." },
    { term: "DEX â€” Delta Exposure", def: "The aggregate delta position held by the dealer community across all outstanding options contracts on a given underlying. DEX quantifies the total directional hedge the dealer book must maintain. A large positive DEX means dealers are net long underlying and must sell into rallies." },
    { term: "GEX â€” Gamma Exposure", def: "The net gamma position of the dealer community at each strike, computed from open interest and the gamma of each contract. Positive GEX at a strike means dealers are long gamma there â€” their hedging activity stabilizes price near that strike. Negative GEX means dealers are short gamma â€” their hedging amplifies moves." },
    ...
    { term: "VEX â€” Vanna Exposure", def: "The sensitivity of dealer delta to changes in implied volatility (dDelta/dIV). VEX is most critical to monitor around scheduled volatility events: FOMC, CPI, earnings. When IV collapses post-event, VEX flows force systematic dealer delta unwinding." },
  ],
  "structural-levels": [
    ...
    { term: "King Node", def: "The dominant positive GEX strike of the day â€” the single level with the greatest total gamma magnitude across all expiries. Price exhibits the strongest magnetic attraction toward the King Node during RTH. The King Node tends to act as the gravitational center of intraday ranging." },
  ...
  "options-fundamentals": [
    { term: "0DTE â€” Zero Days to Expiration", def: "An options contract expiring on the current trading day. SPX PM-settled 0DTE contracts are the primary instrument for the BlackOut play engine. 0DTE options experience extreme theta decay and gamma amplification in the final hours of the session." },
    ...
    { term: "Gamma", def: "The rate of change of delta per $1 move in the underlying. High gamma means delta â€” and therefore P&L â€” changes rapidly with small moves. ATM 0DTE options have the highest gamma and therefore the most violent P&L swings." },
    ...
    { term: "IV Percentile (IVP)", def: "The current implied volatility level expressed as a percentile relative to the past year's IV range. IVP 90 means current IV is higher than 90% of all readings over the past year â€” options are expensive relative to recent history." },
    { term: "Open Interest (OI)", def: "The total number of outstanding option contracts at a given strike and expiry. Open interest is the foundation of GEX computation â€” high OI at a strike concentrates dealer gamma obligations there." },
    ...
    { term: "Vega", def: "The sensitivity of an option's value to a 1-point change in implied volatility. Long options have positive vega â€” they gain value when IV rises. Short options have negative vega." },
  ],
  "price-volume": [
    { term: "VWAP â€” Volume-Weighted Average Price", def: "The average price of a security weighted by volume over a given time period (typically the trading day from market open). VWAP is used by institutional participants as an intraday execution benchmark. SPX trading above VWAP is a bullish structural signal; below is bearish." },
    { term: "EMA â€” Exponential Moving Average", def: "A moving average that places greater weight on recent price data. SPX Slayer uses the 5, 9, and 21 EMA as part of its play engine gate logic. When the EMA stack is aligned (5 > 9 > 21 for bullish; 5 < 9 < 21 for bearish), the trend is confirmed by momentum." },
  ...
  "institutional-flow": [
    ...
    { term: "Sweep", def: "An aggressive options order that simultaneously fills across multiple exchanges to maximize size at the market price. Sweeps indicate institutional urgency â€” the buyer or seller wanted size immediately and was willing to take liquidity across venues." },
  ...
  "platform-terms": [
    ...
    { term: "GEX Regime", def: "The current state of dealer gamma positioning relative to the Gamma Flip. Positive regime: price above the Gamma Flip â€” stabilizing dealer behavior. Negative regime: price below the Gamma Flip â€” amplifying dealer behavior." },
    ...
    { term: "SCANNING", def: "The default state of the SPX Slayer play engine when no qualifying setup has been identified. SCANNING does not mean the market is slow â€” it means the engine has not found a setup that meets all four gate criteria simultaneously." },
      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-12">
        ...
        <div className="mb-12 pb-10 border-b border-cyan-900/40">
          ...
          <p className="text-sky-300 text-xl max-w-3xl leading-relaxed">
            Complete terminology reference for the BlackOut Trading platform â€” every key term, clearly defined with context for how it applies to your workflow.
          </p>
        </div>
        ...
        <div className="flex gap-10 items-start">
          ...
          <main className="flex-1 min-w-0 space-y-10">
            ...
            {[
              { id: "dealer-greeks", title: "Dealer Greeks", subtitle: "The Greek sensitivities that drive dealer hedging â€” the mechanical engine behind structural levels.", accent: "cyan" },
            ...
            <section id="cross-reference">
              ...
              <p className="text-slate-300 leading-relaxed mb-6 text-sm">This table maps each major term to the tools where it is most directly applied.</p>
                ...
                <table className="w-full text-sm">
                  ...
                  <tbody className="divide-y divide-cyan-900/20">
                    {[
                      ...
                      { term: "Active Play Card", primary: "SPX Slayer", also: "â€”" },
                      { term: "SCANNING / APPROVE states", primary: "SPX Slayer", also: "â€”" },
                      { term: "Sweep / Unusual Flow", primary: "HELIX", also: "BlackOut Grid" },
                      { term: "Net Flow Bias", primary: "HELIX", also: "Largo AI" },
                      { term: "Edition", primary: "Night Hawk", also: "â€”" },
                      { term: "Invalidation Level", primary: "Night Hawk", also: "SPX Slayer" },
                      { term: "Verdict (HOLD/TRIM/SELL)", primary: "Night's Watch", also: "â€”" },
                      { term: "Valuation Status", primary: "Night's Watch", also: "â€”" },
                      { term: "Tool Call", primary: "Largo AI", also: "â€”" },
                      ...
                      <tr key={i} className="hover:bg-cyan-950/10 transition-colors">
                        ...
                        <td className="px-5 py-3 text-slate-400 hidden sm:table-cell">{row.also}</td>
                      </tr>
                    ))}
                  </tbody>
                </table>

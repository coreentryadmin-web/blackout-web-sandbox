              ...
              <div className="space-y-5 text-slate-300 leading-relaxed">
                ...
                <div className="p-4 rounded-lg border border-amber-500/20 bg-amber-950/10">
                  ...
                  <p className="text-slate-300 text-sm leading-relaxed">
                    Every position displays one of three valuation status indicators: <span className="text-cyan-400 font-mono">live</span> (chain data fresh within 30 seconds), <span className="text-sky-300 font-mono">stale</span> (chain data present but older than 30 seconds), or <span className="text-slate-400 font-mono">unavailable</span> (options chain cannot be fetched — market closed or contract has expired). Do not rely on P&amp;L figures when status shows <span className="text-slate-400 font-mono">unavailable</span>.
                  </p>
                </div>
              </div>
            </section>

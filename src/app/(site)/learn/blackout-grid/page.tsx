...
export const metadata: Metadata = {
  title: "BlackOut Grid â€” Market Intelligence Hub | BlackOut Trading",
  description:
    "Eight-panel market intelligence dashboard: news, options flow, earnings, catalysts, analyst activity, dark pool, congressional trades, and economic data â€” all in one structured feed.",
};
      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-12">
        ...
        <div className="mb-12 pb-10 border-b border-cyan-900/40">
          ...
          <p className="text-sky-300 text-xl max-w-3xl leading-relaxed">
            Eight panels of structured market intelligence â€” news, flow, catalysts, dark pool, analyst revisions, congressional trades, and economic events â€” unified in a single continuous feed.
          </p>
        </div>
          ...
          <main className="flex-1 min-w-0 space-y-16">
            ...
            <section id="overview">
              ...
              <div className="space-y-4 text-slate-300 leading-relaxed">
                ...
                <p>
                  The Grid is not a trading signal generator. It is the context layer â€” the difference between trading a setup that happens to coincide with a hidden catalyst and trading the same setup with full awareness of the environment.
                </p>
              </div>
            </section>
                ...
                {[
                  {
                    ...
                    usage: "Monitor this panel continuously during the first 30 minutes of RTH. Intraday reversals are frequently news-driven â€” Grid News surfaces the cause faster than most news terminals.",
                  },
                  {
                    num: "02",
                    name: "Options Flow",
                    ...
                    dataSource: "Our flow intelligence engine â€” institutional options feed",
                  ...
                  },
                  {
                    ...
                    usage: "Scan 2â€“5 days ahead. Earnings-driven volatility can ripple through SPX, particularly if a mega-cap (AAPL, MSFT, NVDA) is reporting. Cross-reference with Night Hawk editions to confirm GEX levels account for implied move risk.",
                  },
                  {
                    num: "04",
                    name: "Catalysts",
                  ...
                  },
                  {
                    ...
                    usage: "Large-cap analyst upgrades from bulge-bracket and top-tier institutional firms can generate detectable order flow on HELIX within 15â€“30 minutes of the rating crossing the wire.",
                  },
                  {
                    num: "06",
                    name: "Dark Pool",
                    color: "sky",
                    description: "Large off-exchange (dark pool) block trade prints on major indices and single names. Dark pool activity represents institutional positioning that bypasses lit exchange book â€” the largest risk-capital moves happen here.",
                    dataSource: "Our market data engine â€” institutional dark pool feed",
                  ...
                  },
                  {
                    ...
                    color: "cyan",
                    description: "Congressional stock trading disclosures under the STOCK Act. Filters for statistically significant trades in names with relevant regulatory exposure. Not a primary trading signal â€” a macro context indicator.",
                  ...
                  },
                  {
                    ...
                    usage: "The most critical panel to check before every session. A morning CPI print that deviates significantly from consensus can completely override GEX structural levels â€” the macro thesis takes precedence.",
                  },
                ].map((panel) => (
                  <div key={panel.num} className={`border rounded-xl p-6 ${panel.color === "cyan" ? "border-cyan-900/40 bg-white/[0.018]" : "border-sky-900/30 bg-white/[0.012]"}`}>
                    ...
                    <div className="ml-10 grid sm:grid-cols-2 gap-4">
                      <div className="border border-white/10 rounded-lg p-3">
                        ...
                        <p className="text-sm text-slate-300">{panel.dataSource}</p>
                      </div>
                      <div className="border border-white/10 rounded-lg p-3">
                        <p className="text-xs font-mono text-white/40 uppercase tracking-wider mb-1">How To Use</p>
                        <p className="text-sm text-slate-300 leading-relaxed">{panel.usage}</p>
                      </div>
                    </div>
                  </div>
                ))}
                ...
                {[
                  ...
                  <div key={source.provider} className="flex gap-4 border border-cyan-900/20 rounded-lg bg-white/[0.015] p-5">
                    <div className="shrink-0 w-44">
                      ...
                      <p className="text-xs text-slate-400 mt-1">{source.panels}</p>
                    </div>
                    <p className="text-slate-300 text-sm leading-relaxed">{source.notes}</p>
                  </div>
                ))}
              </div>
            </section>
            ...
            <section id="usage">
              ...
              <div className="space-y-6">
                {[
                  { step: "01", title: "Pre-Market Scan (8:00â€“9:20 AM ET)", body: "Start with the Economic Data panel. Check all scheduled releases. A high-impact release (CPI, FOMC, NFP) in the first 90 minutes of trading fundamentally changes how GEX levels behave. If a major release is pending, hold off on entering the Night Hawk thesis until after the number." },
                  { step: "02", title: "Review Earnings Panel for Active Holdings", body: "Check if any position in Night's Watch has an earnings event scheduled. Night's Watch verdict engine does not account for binary event risk â€” you need to manually assess this using the Earnings panel and reduce position size accordingly." },
                  ...
                  { step: "06", title: "Congress Trades: Sector-Level Context", body: "Review the Congress Trades panel weekly, not intraday. Look for patterns in sector concentration â€” clustered congressional activity in energy or healthcare during policy events is a macro context signal worth noting." },
                ].map((s) => (
            ...
            <section id="dos-donts">
              ...
              <div className="grid sm:grid-cols-2 gap-6">
                ...
                <div className="border border-sky-900/40 rounded-xl bg-sky-950/10 p-6">
                  ...
                  <ul className="space-y-3 text-slate-300 text-sm">
                    {["Don't chase individual news headlines as trading signals in isolation.", "Don't use Congress Trades as a real-time signal â€” disclosures lag the actual trades by days.", "Don't ignore the Economic Data panel just because economic data seems 'macro-level'.", "Don't confuse Grid Options Flow with HELIX â€” they cover different instruments and scopes.", "Don't overwhelm yourself by monitoring all 8 panels simultaneously â€” prioritize by session context."].map((item, i) => (
            ...
            <section id="faq">
              ...
              <div className="space-y-5">
                {[
                  { q: "How frequently does the News panel update?", a: "The News panel updates in near-real time from our financial newswire feed. There is typically a 1â€“3 second latency between headline publication and appearance in the Grid panel." },
                  ...
                  { q: "Why are Congressional trade disclosures delayed so much?", a: "By law, members of Congress must disclose stock trades within 45 days. The Grid surfaces disclosures as soon as they are filed. You are seeing the disclosure, not the trade date â€” use Congress Trades only for long-horizon sector context." },

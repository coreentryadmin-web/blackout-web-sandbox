    ...
    >
          ...
          <section id="overview">
            ...
            <p className="text-secondary leading-relaxed mb-4">
              ...
              intraday index options — dealer gamma exposure, price structure, volatility
              regime, and institutional order flow — into a single, unified view that
            ...
            <p className="text-secondary leading-relaxed mb-4">
              ...
              setups reach the active play card — noise is filtered at the engine layer.
            </p>
          ...
          <section id="how-it-works">
            ...
            <h3 className="text-lg font-semibold text-cyan-400 mt-6 mb-2">
              Play Engine — Sequential Gate Logic
            </h3>
            ...
            <ol className="list-decimal list-inside space-y-3 text-secondary ml-2">
              <li>
                <span className="text-white font-medium">Entry Gates</span> — GEX regime
              ...
              <li>
                <span className="text-white font-medium">Option Ticket Builder</span> —
              ...
              <li>
                <span className="text-white font-medium">Play Open</span> — All four gates
              ...
              <table className="w-full text-sm">
                ...
                <tbody>
                  <tr className="border-b border-white/10">
                    ...
                    <td className="px-4 py-2 text-secondary">All gates pass, bullish setup confirmed — call play opened.</td>
                  </tr>
                  <tr className="border-b border-white/10">
                    <td className="px-4 py-2 text-red-400 font-mono">APPROVE_SELL</td>
                    <td className="px-4 py-2 text-secondary">All gates pass, bearish setup confirmed — put play opened.</td>
                  </tr>
                  <tr>
                    <td className="px-4 py-2 text-sky-300 font-mono">SCANNING</td>
                    <td className="px-4 py-2 text-secondary">One or more gates failed. Engine continues monitoring; no play is open.</td>
                  </tr>
                </tbody>
              </table>
            </div>
          ...
          <section id="key-metrics">
            ...
            <div className="space-y-6">
              {[
                {
                  title: "Live SPX Price — Bid / Ask",
                  body: "Real-time index quote with bid and ask. The spread context matters for 0DTE sizing — wide markets at open or near expiry compress option value faster than the underlying move.",
                },
                {
                  title: "GEX Walls — Call Wall & Put Wall",
                  body: "Gamma Exposure walls derived from the live options chain. The call wall is the strike with the largest positive gamma concentration — dealers become long gamma above it, which suppresses volatility (resistance). The put wall is the strike with the largest negative gamma concentration — dealers are short gamma below it, which amplifies moves (support, but fragile). These levels reprice each engine cycle as open interest shifts.",
                },
                {
                ...
                {
                  title: "IV Percentile",
                  body: "IV Percentile measures where current implied volatility sits relative to its one-year range expressed as a percentile rank. High IVP means options are expensive relative to history; low IVP means they are cheap. This is distinct from IV Rank — the desk displays IVP.",
                },
                {
                  title: "King Node",
                  body: "The single strike with the highest absolute GEX concentration for the session. The King Node acts as a gravitational center — price frequently oscillates around it during low-volatility periods, and a decisive break of the King Node often precedes accelerated directional moves.",
                },
                {
                ...
                <div key={m.title}>
                  ...
                  <p className="text-secondary text-sm leading-relaxed">{m.body}</p>
                </div>
              ))}
            </div>
          </section>
          ...
          <section id="usage">
            ...
            <ol className="space-y-6 text-secondary">
              {[
                {
                  n: "1",
                ...
                },
                {
                  ...
                  body: "During the first 15–30 minutes, let price establish its VWAP relationship. A strong open that holds VWAP with a bullish EMA stack is the setup the engine will lean into.",
                },
                {
                  n: "4",
                ...
                },
                {
                  ...
                  body: "Use Night's Watch to log your position for live P&L and exit tracking. Honor the stop level on the play card — the engine sized R:R at gate evaluation; widening the stop post-entry negates that calculation.",
                },
                {
                  n: "6",
              ...
              <div className="rounded-lg border border-red-500/20 bg-red-500/5 p-5">
                ...
                <ul className="space-y-2 text-sm text-secondary">
                  {[
                    ...
                    "Confuse IV Rank with IV Percentile — the desk displays IVP, not IVR.",
            ...
            <div className="space-y-4">
              {[
                ...
                <div key={ref.href} className="rounded-lg border border-white/10 bg-white/5 p-5">
                  ...
                  <p className="text-secondary text-sm mt-1 leading-relaxed">{ref.desc}</p>
                </div>
              ))}
            </div>
          </section>
            ...
            <div className="space-y-6">
              {[
                ...
                },
                {
                  ...
                  a: "Traditional S/R is historical price memory. GEX walls are derived from current options open interest and the gamma exposure of market makers who must hedge them. GEX walls are forward-looking and mechanistic — they represent strike prices where dealer hedging behavior creates real order flow.",
                },
                {
                  q: "What is the difference between IV Percentile and IV Rank?",
                  a: "IV Rank = (current IV - 52-week low) / (52-week high - 52-week low). It can be distorted by a single volatility spike. IV Percentile counts the percentage of days in the look-back where IV was lower than today — a frequency measure that is more stable across regimes. SPX Slayer displays IVP.",
                },
                {
              ...
              {[
                {
                  ...
                  terms: [
                    ...
                    { term: "Put Wall", def: "The strike with the highest concentration of negative dealer gamma. Dealers short gamma below this level buy into declines, creating a floor — but one that breaks sharply if gamma exposure rolls off." },
                  ...
                  <dl className="space-y-3 text-sm">
                    {group.terms.map((t) => (
                      <div key={t.term}>
                        ...
                        <dd className="text-secondary ml-4 leading-relaxed">{t.def}</dd>
                      </div>
                    ))}
                  </dl>
                </div>

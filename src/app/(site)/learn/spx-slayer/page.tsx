              ...
              <table className="w-full text-sm">
                ...
                <tbody>
                  <tr className="border-b border-white/10">
                    ...
                    <td className="px-4 py-2 text-slate-300">All gates pass, bullish setup confirmed — call play opened.</td>
                  </tr>
                  <tr className="border-b border-white/10">
                    <td className="px-4 py-2 text-red-400 font-mono">APPROVE_SELL</td>
                    <td className="px-4 py-2 text-slate-300">All gates pass, bearish setup confirmed — put play opened.</td>
                  </tr>
                  <tr>

...
// Validate timing config on every cold start so CloudWatch logs surface misconfiguration.
warnIfPlayTimingMisconfigured();

export const dynamic = "force-dynamic";

/** Optional market-hours evaluator — hit from EventBridge/Vercel cron with CRON_SECRET. */

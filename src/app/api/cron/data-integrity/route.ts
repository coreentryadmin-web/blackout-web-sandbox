 ...
 *
 * Hit every ~5 min during market hours from the EventBridge Lambda cron
 * (EventBridge rule (blackout-infra/cron-jobs.json)) with CRON_SECRET. Self-skips outside the RTH window

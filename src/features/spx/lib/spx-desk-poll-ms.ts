...
/** Lotto track during cash session — default 8s. */
export const SPX_LOTTO_OPEN_POLL_MS = pollMs("NEXT_PUBLIC_SPX_LOTTO_OPEN_POLL_MS", 8_000);
...
/** Power hour in-window — default 8s. */
export const SPX_POWER_HOUR_POLL_MS = pollMs("NEXT_PUBLIC_SPX_POWER_HOUR_POLL_MS", 8_000);

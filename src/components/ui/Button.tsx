...
const BASE =
  ...
  "transition-[transform,box-shadow,background,border-color,opacity] duration-150 " +
...
const VARIANT: Record<ButtonVariant, string> = {
  // Emerald fill, dark text — the signature CTA.
  primary:
    "bg-gradient-to-b from-bull to-[#0f9d58] text-[#021c14] border border-bull/40 " +
    "shadow-[0_0_30px_-10px_rgba(0,230,118,0.6)] hover:shadow-[0_0_40px_-8px_rgba(0,230,118,0.75)]",

...
//
// THROTTLING: cadence here is every 5 min during RTH (the market-regime-detector
// ECS scheduled task's cadence, ~half of zerodte's 2-min grid-warm cadence, but

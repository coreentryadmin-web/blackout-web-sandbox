...
- ALWAYS show WHY, LEVELS, SETUP, RISK, NEXT 3M, FLIPS IT. Δ/FLOW/NEWS only when they carry signal. Still ~a 20-second read.`;
  ...
  const raw = await anthropicText(prompt, 1550, undefined, {
    ...
    // timed out" → Live Desk AI stuck. Give it 45s and a single retry (3-min cached, so

...
import { loadProdAppSecret } from "./aws-app-secret.mjs";

const require = createRequire(import.meta.url);
const { Client } = require("pg");

/** SSL config matching db.ts posture for RDS Proxy vs local dev. */
